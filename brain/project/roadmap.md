...
- [ ] **Account-level emergency contacts** — wire TripLinks to reference `contacts.id` rows; wizard step becomes read-only confirm. See [features/emergency-contacts-account-level.md](../features/emergency-contacts-account-level.md)
