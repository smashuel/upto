...
- **Terrain-accurate picking** — `pickEllipsoid` → `scene.pickPosition` / `sampleTerrainMostDetailed`. Core picking + draw-time sampling shipped (commit `0834976`); finish/edit-commit settle heights before the route is emitted/persisted (2026-07-02, see [journal](../journal/2026-07-02-finish-settlement-race.md)); settle window hardened + wizard upserts routes by id (2026-07-03, [journal](../journal/2026-07-03-settle-window-hardening.md) / [ADR 014](../decisions/014-settle-window-is-a-real-state.md)); **waypoints now get the same true-terrain backfill** (2026-07-03 — sampling helper hoisted to the shared `CesiumManager` base; see [journal](../journal/2026-07-03-waypoint-elevation-backfill.md)). Remaining slice: honest degradation when terrain is unavailable (05) — [.scratch/terrain-accurate-picking/](../../.scratch/terrain-accurate-picking/PRD.md). (Stream 1.)
